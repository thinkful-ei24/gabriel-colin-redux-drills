...
import { updateGuesses } from '../actions/actions';

// Seed the store with stuff
store.dispatch(updateGuesses(1));
store.dispatch(updateGuesses(2));
store.dispatch(updateGuesses(3));
